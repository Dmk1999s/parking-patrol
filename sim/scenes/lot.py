...
def approach_pose(st, dist=2.0):
    ...
    한국 번호판은 520×110 mm, 글자 **잉크** 높이 74.8 mm 다 (고시 별표 2-2 —
    셀 높이 85.0 과 헷갈리기 쉽다). AMR 카메라(1280×720, 화각 69°) 기준으로:

        1 m → 글자 69 px  여유     2 m → 35 px  안정적  ← 기본값
        3 m → 23 px  경계          5 m → 14 px  못 읽음
